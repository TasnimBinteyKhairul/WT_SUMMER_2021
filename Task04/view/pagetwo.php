...
<input type="checkbox"  name="dancing" value="dancing" <?php echo $I1;?>> dancing
<input type="checkbox" name=" reading" value=" reading"<?php echo $I2;?>>reading
<input type="checkbox" name="travelling" value="travelling"<?php echo $I3;?>>travelling <br><br>
